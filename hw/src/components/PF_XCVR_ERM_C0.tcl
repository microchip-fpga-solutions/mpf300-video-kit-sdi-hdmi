...
create_and_configure_core -core_vlnv "Actel:SystemBuilder:PF_XCVR_ERM:$PF_XCVR_ERMver" -component_name {PF_XCVR_ERM_C0} -params {\
...
"UI_XCVR_RX_CALIBRATION:On-Demand" \
