# Exporting Component Description of PF_CCC_HDMIRX_SYS_CLK to TCL
# Family: PolarFire
# Part Number: MPF300T-1FCG1152E
# Create and Configure the core component PF_CCC_HDMIRX_SYS_CLK
create_and_configure_core -core_vlnv "Actel:SgCore:PF_CCC:$PF_CCCver" -component_name {PF_CCC_HDMIRX_SYS_CLK} -params {\
...
# Exporting Component Description of PF_CCC_HDMIRX_SYS_CLK to TCL done
