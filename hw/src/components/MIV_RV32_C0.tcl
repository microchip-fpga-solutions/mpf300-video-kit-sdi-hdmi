...
create_and_configure_core -core_vlnv "Microsemi:MiV:MIV_RV32:$MIV_RV32ver" -component_name {MIV_RV32_C0} -params {\
"AHB_END_ADDR_0:0xffff"  \
"AHB_END_ADDR_1:0x8003"  \
...
"AXI_END_ADDR_1:0x74ff"  \
"AXI_INITIATOR_TYPE:2"  \
"AXI_START_ADDR_0:0x0"  \
"AXI_START_ADDR_1:0x7000"  \
