...
create_and_configure_core -core_vlnv "Actel:SystemBuilder:PF_XCVR_ERM:$PF_XCVR_ERMver" -component_name {PF_XCVR_ERM_C1} -params {\
...
"UI_EXPOSE_DYNAMIC_RECONFIGURATION_PORTS:true" \
...
"UI_RX_DATA_RATE:5940" \
"UI_RX_PCS_FAB_IF_WIDTH:40" \
"UI_SATA_IDLE_BURST_TIMING:MAC" \
"UI_TX_CLK_DIV_FACTOR:8" \
"UI_TX_DATA_RATE:928.125" \
